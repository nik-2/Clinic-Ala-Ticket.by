...
(function () {
        ...
        init: function (D, G) {
            ...
            if (this[0]) {
                var I = (this[0].ownerDocument || this[0]).createDocumentFragment(),
                    F = n.clean(J, (this[0].ownerDocument || this[0]), I), H = I.firstChild,
    ...
    n.extend({
        noConflict: function (D) {
            ...
            if (D == "width" || D == "height") {
                var J, E = {position: "absolute", visibility: "hidden", display: "block"},
    ...
    (function () {
        var N = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^[\]]*\]|[^[\]]+)+\]|\\.|[^ >+~,(\[]+)+|[>+~])(\s*,\s*)?/g,
            I = 0, F = Object.prototype.toString;
        ...
        var G = E.selectors = {
            ...
            filter: {
                CHILD: function (P, S) {
                    ...
                    var P = G.attrHandle[R[1]] ? G.attrHandle[R[1]](T) : T[R[1]] || T.getAttribute(R[1]), U = P + "",
                        S = R[2], Q = R[4];
    ...
    (function () {
        n.support = {};
        var E = document.documentElement, F = document.createElement("script"), J = document.createElement("div"),
    ...
    n.fn.extend({
        _load: n.fn.load, load: function (F, I, J) {
            if (typeof F !== "string") {
                return this._load(F)
            }
            var H = F.indexOf(" ");
            ...
            var E = this;
            n.ajax({
                url: F, type: G, dataType: "html", data: I, complete: function (L, K) {
    ...
    n.extend({
        ...
        httpData: function (I, G, F) {
            var E = I.getResponseHeader("content-type"), D = G == "xml" || !G && E && E.indexOf("xml") >= 0,
    ...
    if (document.documentElement.getBoundingClientRect) {
        n.fn.offset = function () {
            ...
            var F = this[0].getBoundingClientRect(), I = this[0].ownerDocument, E = I.body, D = I.documentElement,
                K = D.clientTop || E.clientTop || 0, J = D.clientLeft || E.clientLeft || 0,
        ...
        n.fn.offset = function () {
            ...
            var I = this[0], F = I.offsetParent, E = I, N = I.ownerDocument, L, G = N.documentElement, J = N.body,
                K = N.defaultView, D = K.getComputedStyle(I, null), M = I.offsetTop, H = I.offsetLeft;
    ...
    n.offset = {
        initialize: function () {
            ...
            var K = document.body, E = document.createElement("div"), G, F, M, H, L, D, I = K.style.marginTop,
    ...
    n.fn.extend({
        position: function () {
            var H = 0, G = 0, E;
            if (this[0]) {
                var F = this.offsetParent(), I = this.offset(),
                    D = /^body|html$/i.test(F[0].tagName) ? {top: 0, left: 0} : F.offset();
...
(function ($) {
    $.fn.corner = function (Z) {
        ...
        function drawPixel(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            var o = $(a);
            var p = document.createElement("div");
            $(p).css({height: f, width: "1px", position: "absolute", "font-size": "1px", overflow: "hidden"});
            var q = Math.max(n.tl ? n.tl.radius : 0, n.tr ? n.tr.radius : 0);
            if (h == -1 && i != "") {
                if (q > 0) $(p).css("background-position", "-" + ((m - j - l) + b) + "px -" + ((o.height() + q - l) - c) + "px"); else $(p).css("background-position", "-" + ((m - j - l) + b) + "px -" + ((o.height()) - c) + "px");
                $(p).css({
                    "background-image": i,
                ...
                if (!k) $(p).css("background-color", d).addClass('hasBackgroundColor'); else $(p).css("background-color", d)
            }
            ;
            if (e != 100) setOpacity(p, e);
            $(p).css({top: c + "px", left: b + "px"});
            return p
        };
        ...
        function applyCorners(a, b) {
            ...
            c.addClass('hasCorners').css({"padding": "0", "borderColor": a.style.borderColour, 'overflow': 'visible'});
            if (a.style.position != "absolute") c.css("position", "relative");
            if (($.browser.msie)) {
                if ($.browser.version == 6 && a.style.width == "auto" && a.style.height == "auto") c.css("width", "100%");
                c.css("zoom", "1");
                $(c + " *").css("zoom", "normal")
            }
            for (var t = 0; t < 2; t++) {
            ...
            ;
            if (e) c.css("border-top", 0);
            if (f) c.css("border-bottom", 0);
            var E = ["tr", "tl", "br", "bl"];
            for (var i in E) {
                if (i > -1 < 4) {
                    var F = E[i];
                    if (!b[F]) {
                        if (((F == "tr" || F == "tl") && e != null) || ((F == "br" || F == "bl") && f != null)) {
                            ...
                            $(G).css({position: "relative", "font-size": "1px", overflow: "hidden"});
                            if (u == "") $(G).css("background-color", s); else $(G).css("background-image", u).css("background-color", s);
                            switch (F) {
                                case"tl":
                                    $(G).css({
                                        height: x - n,
                        ...
                        if (g[b[F].radius]) {
                            ...
                            for (var I = 0, j = b[F].radius; I < j; I++) {
                                if ((I + 1) >= H) var J = -1; else var J = (Math.floor(Math.sqrt(Math.pow(H, 2) - Math.pow((I + 1), 2))) - 1);
                                if (H != j) {
                                    if ((I) >= H) var K = -1; else var K = Math.ceil(Math.sqrt(Math.pow(H, 2) - Math.pow(I, 2)));
                                    if ((I + 1) >= j) var L = -1; else var L = (Math.floor(Math.sqrt(Math.pow(j, 2) - Math.pow((I + 1), 2))) - 1)
                                }
                                ;
                                if ((I) >= j) var M = -1; else var M = Math.ceil(Math.sqrt(Math.pow(j, 2) - Math.pow(I, 2)));
                                if (J > -1) G.appendChild(drawPixel(a, I, 0, s, 100, (J + 1), G, -1, u, b[F].radius, 0, n, m, b));
                                if (H != j) {
                                    for (var N = (J + 1); N < K; N++) {
                                        if (b.antiAlias) {
                                            if (u != "") {
                            ...
                            for (var t = 0, k = G.childNodes.length; t < k; t++) {
                                ...
                                switch (F) {
                                    ...
                                    case"tl":
                                        ...
                                        break;
                                    case"bl":
                                        if (x > 0) $(R).css("background-position", "-" + Math.abs((b[F].radius - T - 1) - n) + "px -" + Math.abs((c.height() + x - n + 1)) + "px"); else $(R).css("background-position", "-" + Math.abs((b[F].radius - T - 1) - n) + "px -" + Math.abs((c.height())) + "px");
                                        break
                                }
                            }
                        }
                    ...
                    if (G) {
                        switch (F) {
                            case"tl":
                                if ($(G).css("position") == "absolute") $(G).css("top", "0");
                                if ($(G).css("position") == "absolute") $(G).css("left", "0");
                                if (e) e.appendChild(G);
                                break;
                            case"tr":
                                if ($(G).css("position") == "absolute") $(G).css("top", "0");
                                if ($(G).css("position") == "absolute") $(G).css("right", "0");
                                if (e) e.appendChild(G);
                                break;
                            case"bl":
                                if ($(G).css("position") == "absolute") $(G).css("bottom", "0");
                                if (G.style.position == "absolute") $(G).css("left", "0");
                        ...
                        case"t":
                            if (e) {
                                if (b.tl.radius && b.tr.radius) {
                                    ...
                                    if (u != "") $(Y).css("background-position", "-" + (x + n) + "px 0px");
                                    e.appendChild(Y)
                                }
                        ...
                        case"b":
                            if (f) {
                                if (b.bl.radius && b.br.radius) {
                                    ...
                                    if (u != "" && x > 0) $(Y).css("background-position", "-" + (b.bl.radius - n) + "px -" + (c.height() + x - n + 1) + "px"); else $(Y).css("background-position", "-" + (b.bl.radius - n) + "px -" + (c.height()) + "px").addClass('hasBackgroundColor');
                                    f.appendChild(Y)
                                }
                            }
                            ;
        ...
        if (Z && typeof (Z) != 'string') $.extend(bb, Z);
        return this.each(function () {
